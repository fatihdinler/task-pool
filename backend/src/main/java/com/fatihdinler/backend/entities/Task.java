package com.fatihdinler.backend.entities;
...
public class Task {
  ...
  @Id
  // JPA will handle the generation of the id. No need to set it manually.
  @GeneratedValue(strategy = GenerationType.UUID)
  // This annotation allows us to specify that id field should not be updatable and nullable,
  // which means that id field should always have a value and this value cannot be change once it created.
  @Column(name = "id", updatable = false, nullable = false)
  private UUID id;

  // The default value of the parameter 'updatable' is true, so no need to pass as 'updatable = true' a parameter.
