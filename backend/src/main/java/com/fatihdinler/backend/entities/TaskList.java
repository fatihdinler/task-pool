...
public class TaskList {
  ...
  // One task_list to many tasks
  @OneToMany(
    mappedBy = "taskList",
    cascade = {
      CascadeType.REMOVE, // When we delete a task list, all the tasks will be deleted too.
      CascadeType.PERSIST // When we save a task list, all the tasks will be saved too.
    })
